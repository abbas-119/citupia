<template>
  <div class="h-screen w-screen flex justify-center content-center dark:bg-gradient-to-r dark:from-gray-700 dark:via-gray-900 dark:to-black bg-gradient-to-r from-blue-200 to-blue-500">
